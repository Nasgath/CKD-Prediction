...
class dataUploadView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        #print('inside form')['bgr','bu','sc','pcv','wbc'])
        if form.is_valid():
            form.save()
            ...
            classifier,Accuracy,report,X_test,y_test,cm=obj.random(selectk_feature,indep_X,dep_Y)

            #data = data.reshape(1, -1) ,X_test1
            ...
            ser = pd.DataFrame(data, index =['bgr','bu','sc','pcv','wc'])
            ss=ser.T.squeeze()
